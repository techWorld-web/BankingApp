...
<!--===============================================================================================-->
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="CreateAccount" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Branch Name</span>
					<input class="input100" type="text" name="bname" placeholder="Enter your Branch name">
					<span class="focus-input100"></span>
				</div>		
				<div class="wrap-input100 input100-select">
					...
					<div class="wrap-input100 input100-select">
					<span class="label-input100">Select Account Type</span>
					<div>
						<select class="selection-2" name="type">
							<option value="Deposit">Savings</option>
							<option value="Withdraw">Zero Balance</option>
							<option value="Deposit">General Account</option>
						</select>
					</div>
					<span class="focus-input100"></span>
				</div>
