					...
					<div class="menu_block">
						<nav id="bt-menu" class="bt-menu">
							...
							<ul>
								...
								<li class="bt-icon"><a href="CreateAccount.jsp">Create Account</a></li>
...
<!--==============================Content=================================-->
	<% Class.forName("com.mysql.jdbc.Driver"); %>
       ...
       ResultSet resultset = statement.executeQuery("select id,date,bank,type,accno,reference,withdraw,deposit,balance from debitedamount") ;
       %>
<TABLE BORDER="1" align="center" style="width:80%;border:1px solid black;" "text-align:center">
        <TR>
